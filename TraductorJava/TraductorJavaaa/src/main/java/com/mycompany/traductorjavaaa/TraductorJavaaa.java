package com.mycompany.TraductorJavaaa;

import java.util.HashMap;
import java.util.Scanner;
public class TraductorJavaaa {
    ...
    public static HashMap<Integer, String> obtenerNumeros(String idioma) {
        ...
        // Añade el resto de los números hasta 100
    ...
    public static HashMap<String, String[]> obtenerTextos() {
        ...
        mensajes.put("SumaESP", new String[]{"La suma de ", " más ", " es "});
        mensajes.put("SumaENG", new String[]{"The sum of ", " plus ", " is "});
        mensajes.put("InstruccionesESP", new String[]{"Digite el primer número (0-100):", "Digite el segundo número (0-100):"});
    ...
    public static void main(String[] args) {
        ...
        // Mostrar instrucciones en el idioma seleccionado
        ...
        // Generar las frases en ambos idiomas
        ...
        // Imprimir resultados en ambos idiomas
